  ...
  return (
    <header className=" w-100">
      ...
      >
        ...
        <div className="col d-flex justify-content-center">
          <a className="btn btn-white my-auto">Publish</a>
        </div>
      </div>
      <div className="mobile-content  justify-content-around p-3">
        <a onClick={() => navigate("/")} className="m-0 text-decoration-none">
          <svg
            fill="currentColor"
            version="1.1"
            id="Capa_1"
